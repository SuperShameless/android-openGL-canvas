...
package com.chillingvan.canvasglsample.textureView.camera.open;
...
public final class OpenCameraInterface {
    ...
    public static final int CAMERA_FACING_UNSPECIFIED = -1;
    ...
    public static OpenCamera open(int cameraId) {
        return open(cameraId, CAMERA_FACING_UNSPECIFIED);
    }

    public static OpenCamera open(int cameraId, int cameraFacing) {
        ...
        if (explicitRequest) {
            ...
            index = 0;
            CameraFacing facing = cameraFacing == CAMERA_FACING_FRONT ?
        ...
        if (selectedCameraInfo != null &&
                cameraFacing != CAMERA_FACING_UNSPECIFIED &&
                selectedCameraInfo.facing != cameraFacing) {
            Log.w(TAG, "Requested camera facing " + cameraFacingToString(cameraFacing) +
                    " but get facing " + cameraFacingToString(selectedCameraInfo.facing));
            return null;
        }
